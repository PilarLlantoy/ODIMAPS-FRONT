...
const SimulacionHastaElColapso = () => {
  ...
  return (
    <Box sx={{ p:'1.5rem' }}>
      <Title text={'Simulación hasta el colapso'}></Title>
      <Box sx={{ display: 'flex' }}>
        ...
        >
          <DialogTitle id="alert-dialog-title">
            Informe de colapso logístico
          </DialogTitle>
          <DialogContent>
            {pedidoColapso && <DialogContentText id="alert-dialog-description">
              <div>
                {`Número de rutas llevadas a cabo con éxito: ${nroRutasCumplidas}`}
              </div>
              <div>
              ...
              <div>
                ...
                <li>
                  {`Región: ${pedidoColapso.destino.region}`}
                </li>
                <li>
                  {`Fecha de registro: ${pedidoColapso.fechaRegistro}`}
                </li>
                <li>
                  {`Fecha máx. entrega: ${pedidoColapso.fechaEntregaMax}`}
                </li>
              </div>
            </DialogContentText>}
          </DialogContent>
